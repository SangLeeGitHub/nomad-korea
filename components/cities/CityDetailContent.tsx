...
function RelatedCities({ relatedCities }: { relatedCities: City[] }) {
  return (
    <Card className="mt-8">
      <CardHeader>
...
export function CityDetailContent({ city, detail, relatedCities }: CityDetailContentProps) {
  ...
  return (
    <>
      ...
      {/* Related Cities */}
      <RelatedCities relatedCities={relatedCities} />
    </>
  );
}
