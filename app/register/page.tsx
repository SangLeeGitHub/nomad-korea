...
import { Mail, Lock, ArrowRight, Check, AlertCircle, CheckCircle } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 via-background to-secondary/5 px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-foreground mt-4">회원가입</h1>
          <p className="text-muted-foreground mt-2">
            새로운 계정을 만들고 디지털 노마드 여정을 시작하세요
          </p>
        </div>
        ...
        <div className="mt-6 p-4 bg-muted/50 rounded-lg">
          <p className="text-sm font-medium text-foreground mb-3">회원 가입 혜택</p>
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex items-center gap-2">
              <Check className="h-4 w-4 text-primary" />
              전국 50개 도시 상세 정보 무제한 열람
            </li>
            <li className="flex items-center gap-2">
              <Check className="h-4 w-4 text-primary" />
              밋업 참여 및 네트워킹 기회
